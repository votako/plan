...
<form action="index.php?volpasswd=0066" method="post">
<br>
<table cellspacing="0" cellpadding="0" style="border-collapse: collapse" align=center><tr>
<td>

<b>Дата 1:</b><div><input type="text" name="date_m1" id="date_m1" datepicker="true" datepicker_format="DD-MM-YYYY"></div>
</td>
<td>
<b>Дата 2:</b><div><input type="text" name="date_m2" id="date_m2" datepicker="true" datepicker_format="DD-MM-YYYY"></div>
</td>
